...
import { calculateFractalSubdivision, calculateFractalSubdivisionOnlyHeight, calculateOffsetFromStraightLine, createFractalSubdivisionPerlinOnlyHeight } from "../lib/subdivision.js";
...
export default class FractalCircle {
    ...
    draw(centerPosition: Vec2) {
        ...
        const emptyVecArray: Vec2[] = new Array(40);
...
function mapOffsetsToCircle(offsets: Vec2[], radius: number, startAngleDegrees: number): Vec2[] {
...
function rotateVector(vector: Vec2, angleRadians: number): Vec2 {
